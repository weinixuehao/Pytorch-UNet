    ...
    for epoch in range(1, epochs+1):
        ...
        if epoch % 5 == 0:
            ...
            for batchidx, (preds_mask, true_masks) in enumerate(image_tuples):
                ...
                #         image_tuples, val_score = evaluate(net, val_loader, device)
                #         for idx, (pred_mask, true_mask) in enumerate(image_tuples):
                #             cv2.imwrite(f"{output_dir}/{idx}_pred_mask.jpg", pred_mask)
                #             cv2.imwrite(f"{output_dir}/{idx}_true_mask.jpg", true_mask)
